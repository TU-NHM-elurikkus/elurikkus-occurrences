...
<html>
    <head>
        ...
        <title>
            <g:message code="eya.title01" default="Explore Your Area" /> | <g:message code="eya.title02" default="Atlas of Living Australia" />
        </title>
    ...
    <body class="nav-locations explore-your-area">
                ...
                <div class="form-linline float-right">
                    <p>
                        ...
                        <select id="radius" name="radius" class="">
                            <option value="1" <g:if test="${radius == 1}">selected</g:if>>
                                1
                            </option>
                            <option value="5" <g:if test="${radius == 5}">selected</g:if>>
                                5
                            </option>
                            <option value="10" <g:if test="${radius == 10}">selected</g:if>>
                                10
                            </option>
                        </select>
        ...
        <div class="row">
                    ...
                    <div id="leftList">
                        <table id="taxa-level-0">
                            <thead>
                                <tr>
                                    <th>
                                        <g:message code="eya.table.01.th01" default="Group" />
                                    </th>
                                    <th>
                                        <g:message code="eya.table.01.th02" default="Species" />
                                    </th>
                                </tr>
                            </thead>
            ...
            <div class="col">
                ...
                <div id="mapTips">
                    <b>
                        <g:message code="eya.maptips.01" default="Tip" />
                    </b>:
