    ...
    <div class="sidebar" style="float:left;">
        ...
        <button class="erk-button erk-button--light" id="assertionButton" href="#loginOrFlag" role="button" data-toggle="modal" title="report a problem or suggest a correction for this record">
            <span id="loginOrFlagSpan" title="Flag an issue" class="">
                <span class="icon-flag"></span>&nbsp;<g:message code="show.loginorflag.title"/>
            </span>
        </button>
        --}%
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <g:if test="${!userId}">
                            <div style="margin: 20px 0;"><g:message code="show.loginorflag.label.01"/>
                        ...
                        <g:else>
                            <div>
                                %{-- XXX --}%
                                <g:message code="show.loginorflag.label.02"/>  <strong>${userDisplayName} (${alatag.loggedInUserEmail()})</strong>.

                                <form id="issueForm">
                                    <p style="margin-top:20px;">
                                        <label for="issue"><g:message code="show.issueform.label.01"/></label>
                                    ...
                                    <p style="margin-top:30px;">
                                        <label for="issueComment" style="vertical-align:top;"><g:message code="show.issueform.label.02"/></label>
                                        <textarea name="comment" id="issueComment" style="width:380px;height:150px;" placeholder="Please add a comment here..."></textarea>
                                    </p>

                                    <p style="margin-top:20px;">
                                        <input id="issueFormSubmit" type="submit" value="<g:message code="show.issueform.button.submit"/>" class="erk-button erk-button--light" />
                                        <input type="reset" value="<g:message code="show.issueform.button.cancel"/>" class="erk-button erk-button--light" onClick="$('#loginOrFlag').modal('hide');"/>
                                        <input type="button" id="close" value="<g:message code="generic.button.close"/>" class="erk-button erk-button--light" style="display:none;"/>
                    ...
                    <div class="hide modal-footer">
                        <button class="erk-button erk-button--light" data-dismiss="modal" aria-hidden="true" style="float:right;"><g:message code="generic.button.close"/></button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="sidebar-general-info">
    ...
    <g:if test="${record.processed.occurrence.outlierForLayers}">
        <div class="sidebar-general-info__item">
            <a href="#outlierInformation"><g:message code="show.outlierinformation.title"/></a>
        </div>
    </g:if>

    <g:if test="${record.processed.occurrence.duplicationStatus}">
        <div class="sidebar-general-info__item">
            <a href="#inferredOccurrenceDetails"><g:message code="show.inferredoccurrencedetails.title"/></a>
        </div>
    </g:if>
</div>
    ...
    <div class="sidebar">
        <div id="warnings">
            ...
            <div id="systemAssertionsContainer" <g:if test="${!record.systemAssertions}">style="display:none"</g:if>>
                <h3><g:message code="show.systemassertioncontainer.title"/></h3>
            ...
            <div id="userAssertionsContainer" <g:if test="${!record.userAssertions && !queryAssertions}">style="display:none"</g:if>>
                <h3><g:message code="show.userassertionscontainer.title"/></h3>
...
%{--<g:if test="${isCollectionAdmin && (record.systemAssertions.failed || record.userAssertions) && ! recordIsVerified}">
    <div class="sidebar">
        <button class="erk-button erk-button--light" id="verifyButton" href="#verifyRecord" data-toggle="modal">
            <span id="verifyRecordSpan" title=""><g:message code="show.button.verifybtn.span"/></span>
        </button>
        ...
        <div id="verifyRecord" class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="loginOrFlagLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div id="verifyAsk">
                    ...
                    <p style="margin-top:20px;">
                        <label for="userAssertionStatus"><g:message code="show.verifyrecord.p03"/></label>
            ...
            <div class="modal-footer">
                <div id="verifyDone" style="display:none;">
                    ...
                    <br/>
                    <button class="erk-button erk-button--light closeVerify" data-dismiss="modal"><g:message code="generic.button.close"/></button>
                </div>
            </div>
        </div>
    </div>
...
<g:if test="${record.processed.attribution.provenance && record.processed.attribution.provenance == 'Draft'}">
    <div class="sidebar">
        <p class="grey-bg" style="padding:5px; margin-top:15px; margin-bottom:10px;">
            ...
            <a href="http://volunteer.ala.org.au/"><g:message code="show.sidebar01.volunteer.navigator"/></a>.
        </p>

        <button class="erk-button erk-button--light" id="viewDraftButton" >
            <span id="viewDraftSpan" title="View Draft"><g:message code="show.button.viewdraftbutton.label"/></span>
        </button>
    </div>
</g:if>
...
<g:if test="${record.images}">
    <div class="sidebar">
        <h2 id="images"><g:message code="show.sidebar03.title"/></h2>
            ...
            <g:each in="${record.images}" var="image">
                <div style="margin-bottom:10px;">
                    ...
                    <g:if test="${record.raw.occurrence.photographer || image.metadata?.creator}">
                        <cite><g:message code="show.sidebar03.cite01"/>: ${record.raw.occurrence.photographer ?: image.metadata?.creator}</cite><br/>
                    </g:if>
                    <g:if test="${record.raw.occurrence.rights || image.metadata?.rights}">
                        <cite><g:message code="show.sidebar03.cite02"/>: ${record.raw.occurrence.rights ?: image.metadata?.rights}</cite><br/>
                    </g:if>
                    <g:if test="${record.raw.occurrence.rightsholder || image.metadata?.rightsholder}">
                        <cite><g:message code="show.sidebar03.cite03"/>: ${record.raw.occurrence.rightsholder ?: image.metadata?.rightsholder}</cite><br/>
                    </g:if>
                    <g:if test="${record.raw.miscProperties.rightsHolder}">
                        <cite><g:message code="show.sidebar03.cite03"/>: ${record.raw.miscProperties.rightsHolder}</cite><br/>
                    </g:if>
                    <g:if test="${image.metadata?.license}">
                        <cite><g:message code="show.sidebar03.image.license"/>: ${image.metadata?.license}</cite><br/>
                    </g:if>
                    <g:if test="${grailsApplication.config.skin.useAlaImageService.toBoolean()}">
                        <a href="${grailsApplication.config.images.metadataUrl}${image.filePath}" target="_blank"><g:message code="show.sidebar.occurrenceimages.navigator01"/></a>
                    </g:if>
                    <g:else>
                        <a href="${image.alternativeFormats.imageUrl}" target="_blank"><g:message code="show.sidebar.occurrenceimages.navigator02"/></a>
                    </g:else>
                </div>
            </g:each>
        </div>
...
<g:if test="${record.sounds}">
    <div class="sidebar">
        <h3 id="soundsHeader" style="margin: 20px 0 0 0;"><g:message code="show.soundsheader.title"/></h3>
        <div class="row-fluid">
        ...
        <g:if test="${record.raw.occurrence.rights}">
            <br/>
            <cite><g:message code="show.sidebar04.cite"/>: ${record.raw.occurrence.rights}</cite>
        </g:if>
        <p>
            <g:message code="show.sidebar04.p"/>
        </p>
    </div>
</g:if>
...
<g:if test="${record.raw.lastModifiedTime && record.processed.lastModifiedTime}">
    ...
    <div class="sidebar" style="margin-top: 10px;font-size: 12px; color: #555;">
        ...
        <p style="margin-bottom:20px;">
            <g:message code="show.sidebar05.p01"/>: ${rawLastModifiedString}<br/>
            <g:message code="show.sidebar05.p02"/>: ${processedLastModifiedString}<br/>
        </p>
    </div>
</g:if>
...
<div id="dataQuality" class="additionalData">
    ...
    <h2><g:message code="show.dataquality.title"/></h2>
