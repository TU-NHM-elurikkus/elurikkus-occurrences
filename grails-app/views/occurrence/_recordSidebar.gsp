                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <g:if test="${!userId}">
                            <div style="margin: 20px 0;">
                                <g:message code="show.loginorflag.div01.label" default="Login please:" />
                        ...
                        <g:else>
                            <div>
                                <%-- XXX --%>
                                <g:message code="show.loginorflag.div02.label" default="You are logged in as" />
                                <strong>
                                ...
                                <form id="issueForm">
                                    <p style="margin-top:20px;">
                                        <label for="issue">
                                            <g:message code="show.issueform.label01" default="Issue type:" />
                                        </label>
                                    ...
                                    <p style="margin-top:30px;">
                                        <label for="issueComment" style="vertical-align:top;">
                                            <g:message code="show.issueform.label02" default="Comment:" />
                                        </label>
                    ...
                    <div class="hide modal-footer">
                        <button class="erk-button erk-button--light" data-dismiss="modal" aria-hidden="true" style="float:right;">
                            <g:message code="show.loginorflag.divbutton" default="Close" />
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="sidebar" style="float:left;">
        ...
        >
            <span id="contactCuratorSpan" href="#contactCuratorView" title="">
                ...
                <g:message code="show.showcontactcurator.span" default="Contact curator" />
            </span>
        </button>
    </div>
</g:if>
    ...
    <g:if test="${record.processed.occurrence.outlierForLayers}">
        <div class="sidebar-general-info__item">
            <a href="#outlierInformation">
                <g:message code="show.outlierinformation.title" default="Outlier information" />
            </a>
        </div>
    </g:if>
    ...
    <g:if test="${record.processed.occurrence.duplicationStatus}">
        <div class="sidebar-general-info__item">
            <a href="#inferredOccurrenceDetails">
                <g:message code="show.inferredoccurrencedetails.title" default="Inferred associated occurrence details" />
            </a>
        </div>
    </g:if>
</div>
    ...
    <div class="sidebar">
        <div id="warnings">
            ...
            <div id="userAssertionsContainer" <g:if test="${!record.userAssertions && !queryAssertions}">style="display:none"</g:if>>
                <h3>
                    <g:message code="show.userassertionscontainer.title" default="User flagged issues" />
                </h3>
    ...
    <div class="sidebar">
        <p class="grey-bg" style="padding:5px; margin-top:15px; margin-bottom:10px;">
            ...
            <a href="http://volunteer.ala.org.au/">
                <g:message code="show.sidebar01.volunteer.navigator" default="Biodiversity Volunteer Portal" />
            </a>.
        </p>

        <button class="erk-button erk-button--light" id="viewDraftButton" >
            <span id="viewDraftSpan" title="View Draft">
                <g:message code="show.button.viewdraftbutton.span" default="See draft in Biodiversity Volunteer Portal" />
            </span>
        </button>
    </div>
</g:if>
            ...
            <g:each in="${record.images}" var="image">
                <div style="margin-bottom:10px;">
                    ...
                    <g:if test="${record.raw.occurrence.photographer || image.metadata?.creator}">
                        <cite>
                            <g:message code="show.sidebar03.cite01" default="Photographer" />: ${record.raw.occurrence.photographer ?: image.metadata?.creator}
                        </cite>
                        <br />
                    </g:if>
                    <g:if test="${record.raw.occurrence.rights || image.metadata?.rights}">
                        <cite>
                            <g:message code="show.sidebar03.cite02" default="Rights" />: ${record.raw.occurrence.rights ?: image.metadata?.rights}
                        </cite>
                        <br />
                    </g:if>
                    <g:if test="${record.raw.occurrence.rightsholder || image.metadata?.rightsholder}">
                        <cite>
                            <g:message code="show.sidebar03.cite03" default="Rights holder" />: ${record.raw.occurrence.rightsholder ?: image.metadata?.rightsholder}
                        </cite>
                        <br />
                    </g:if>
                    <g:if test="${record.raw.miscProperties.rightsHolder}">
                        <cite>
                            <g:message code="show.sidebar03.cite03" default="Rights holder" />: ${record.raw.miscProperties.rightsHolder}
                        </cite>
                        <br />
                    </g:if>
                    <g:if test="${image.metadata?.license}">
                        <cite>
                            <g:message code="show.sidebar03.image.license" default="License" />: ${image.metadata?.license}
                        </cite>
                        <br />
                    </g:if>
                    <g:if test="${grailsApplication.config.skin.useAlaImageService.toBoolean()}">
                        <a href="${grailsApplication.config.images.metadataUrl}${image.filePath}" target="_blank">
                            <g:message code="show.sidebardiv.occurrenceimages.navigator01" default="View image details" />
                        </a>
                    </g:if>
                    <g:else>
                        <a href="${image.alternativeFormats.imageUrl}" target="_blank">
                            <g:message code="show.sidebardiv.occurrenceimages.navigator02" default="Original image" />
                        </a>
                    </g:else>
                </div>
            </g:each>
...
<g:if test="${record.sounds}">
    <div class="sidebar">
        ...
        <g:if test="${record.raw.occurrence.rights}">
            <br />
            <cite>
                <g:message code="show.sidebar04.cite" default="Rights" />: ${record.raw.occurrence.rights}
            </cite>
        </g:if>
        <p>
...
<g:if test="${record.raw.lastModifiedTime && record.processed.lastModifiedTime}">
    ...
    <div class="sidebar" style="margin-top: 10px;font-size: 12px; color: #555;">
        ...
        <p style="margin-bottom:20px;">
            <g:message code="show.sidebar05.p01" default="Date loaded" />: ${rawLastModifiedString}
            <br />
            <g:message code="show.sidebar05.p02" default="Date last processed" />: ${processedLastModifiedString}
            <br />
        </p>
    </div>
</g:if>
        ...
        <thead>
            <tr class="sectionName">
                <td class="dataQualityTestName">
                    <g:message code="show.tabledataqualityresultscol01.title" default="Test name" />
                </td>
                <td class="dataQualityTestResult">
                    <g:message code="show.tabledataqualityresultscol02.title" default="Result" />
                </td>
            </tr>
        </thead>
        ...
        <tbody>
                ...
                <tr>
                    <td colspan="2">
                        <a href="javascript:void(0)" id="showMissingPropResult">
                            <g:message code="show.tabledataqualityresults.tr04td02" default="Show/Hide" />  ${record.systemAssertions.missing.length()} missing properties
                        </a>
                    </td>
                </tr>
            </g:if>
            ...
            <g:each in="${testSet}" var="test">
                <tr class="missingPropResult" style="display:none;">
                    ...
                    <td>
                        <i class="fa fa-question-circle"></i> <g:message code="show.tabledataqualityresults.tr05td02" default="Missing" />
                    </td>
                </tr>
            </g:each>
                ...
                <tr>
                    <td colspan="2">
                        <a href="javascript:void(0)" id="showUncheckedTests">
                            <g:message code="show.tabledataqualityresults.tr06td02" default="Show/Hide" />  ${record.systemAssertions.unchecked.length()} tests that have not been run
                        </a>
                    </td>
                </tr>
            </g:if>
            ...
            <g:each in="${testSet}" var="test">
                <tr class="uncheckTestResult" style="display:none;">
                    ...
                    <td>
                        <i class="fa fa-ban"></i> <g:message code="show.tabledataqualityresults.tr07td02" default="Unchecked (lack of data)" />
                    </td>
                </tr>
            </g:each>
        </tbody>
