...
<html>
    <head>
        ...
        <title>
            <g:message code="show.title" default="Record" />: ${recordId} | <g:message code="show.occurrenceRecord" default="Occurrence record" />  | ${hubDisplayName}
        </title>
    ...
    <body class="occurrence-record">
        ...
        <g:if test="${record}">
            <g:if test="${record.raw}">
                ...
                <g:if test="${hasExpertDistribution}">
                    <div id="hasExpertDistribution"  class="additionalData" style="clear:both;padding-top: 20px;">
                        <h2>
                            <g:message code="show.hasexpertdistribution.title" default="Record outside of expert distribution area (shown in red)" />
                ...
                <div class="row">
                    <div class="col-12">
                        <div id="userAnnotationsDiv" class="additionalData">
                            ...
                            <h4>
                                <g:message code="user.assertion.status" default="User Assertion Status" />:
                                <i>
                        ...
                        <div id="outlierInformation" class="additionalData">
                            ...
                            <p>
                                ...
                                <a href="https://github.com/AtlasOfLivingAustralia/ala-dataquality/wiki/DETECTED_OUTLIER_JACKKNIFE">
                                    <g:message code="show.outlierinformation.p.vavigator" default="Reverse Jackknife algorithm" />
                                </a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://docs.google.com/open?id=0B7rqu1P0r1N0NGVhZmVhMjItZmZmOS00YmJjLWJjZGQtY2Y0ZjczZmUzZTZl">
                                            <g:message code="show.outlierinformation.p.li02" default="Notes on Methods for Detecting Spatial Outliers" />
                                        </a>
                                    </li>
                                </ul>
                            </p>
    				...
    				<g:if test="${record.processed.occurrence.duplicationStatus}">
    					<div id="inferredOccurrenceDetails">
                            ...
                            <p style="margin-top:5px;">
                                ...
                                <g:else>
                                    <g:message code="show.inferredoccurrencedetails.p02" default="This record is associated with the representative record." />
                                </g:else>
                            ...
                            <g:if test="${duplicateRecordDetails && duplicateRecordDetails.duplicates?.size() > 0}">
                                <table class="duplicationTable table table-sm table-striped table-bordered" style="border-bottom:none;">
                                    <tr class="sectionName">
                                        <td colspan="4">
                                            <g:message code="show.table01.title" default="Representative Record" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="sectionName">
                                        <td colspan="4">
                                            <g:message code="show.table02.title" default="Related records" />
                                        </td>
                                    </tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>
                                                    <g:message code="show.processedvsrawview.table.th01" default="Group" />
                                                </th>
                                                <th>
                                                    <g:message code="show.processedvsrawview.table.th02" default="Field Name" />
                                                </th>
                                                <th>
                                                    <g:message code="show.processedvsrawview.table.th03" default="Original Value" />
                                                </th>
                                                <th>
                                                    <g:message code="show.processedvsrawview.table.th04" default="Processed Value" />
                                                </th>
                                            </tr>
                                        </thead>
                                    ...
                                    <address>
                                        ...
                                        <g:if test="${c.contact.email}">
                                            ...
                                            <alatag:emailLink email="${c.contact.email}">
                                                <g:message code="show.contactcuratorview.emailtext" default="email this contact" />
                                            </alatag:emailLink>
            ...
            <ul style="display:none;">
                <li id="userAnnotationTemplate" class="userAnnotationTemplate well">
                    <h3>
                        <span class="issue" />
                        -
                        <g:message code="show.userannotationtemplate.title" default="flagged by" />
                    ...
                    <g:if test="${isCollectionAdmin}">
                        <p class="verifyAnnotation" style="display:none;">
                            <a class="verifyAnnotationButton erk-button erk-button--light" href="#verifyRecordModal" data-toggle="modal">
                                <g:message code="show.userannotationtemplate.p03.navigator" default="Verify this annotation" />
                            </a>
                        </p>
                    </g:if>
                </li>
                        ...
                        <div class="modal-body">
                            <div id="verifyAsk">
                                ...
                                <g:if test="!record.processed.geospatiallyKosher">
                                    <g:set var="markedAssertions">
                                        <g:message code="show.verifyask.set01" default="geospatially suspect" />
                                    </g:set>
                                </g:if>

                                <g:if test="!record.processed.taxonomicallyKosher">
                                    <g:set var="markedAssertions">
                                        ${markedAssertions}${markedAssertions ? ", " : ""}<g:message code="show.verifyask.set02" default="taxonomically suspect" />
                                    </g:set>
                                </g:if>
                                ...
                                <p style="margin-top:20px;">
                                    ...
                                    <select name="userAssertionStatusSelection" id="userAssertionStatusSelection">
                                        <option value="50001">
                                            <alatag:message code="user_assertions.50001" default="Open issue" />
                                        </option>
                                        <option value="50002">
                                            <alatag:message code="user_assertions.50002" default="Verified" />
                                        </option>
                                        <option value="50003">
                                            <alatag:message code="user_assertions.50003" default="Corrected" />
                                        </option>
                                    </select>
                                </p>
                                ...
                                <button id="confirmVerify" class="erk-button erk-button--light confirmVerify">
                                    <g:message code="show.verifyrecord.btn.confirmverify" default="Confirm" />
                                </button>
                                <button class="erk-button erk-button--light cancelVerify"  data-dismiss="modal">
                                    <g:message code="show.verifyrecord.btn.cancel" default="Cancel" />
                                </button>
                        ...
                        <div class="modal-footer">
                            <div id="verifyDone" style="display:none;">
                                ...
                                <button class="erk-button erk-button--light closeVerify" data-dismiss="modal">
                                    <g:message code="show.verifydone.btn.closeverify" default="Close" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <g:if test="${!record.raw}">
                <div id="headingBar">
                    <h1>
                        <g:message code="show.headingbar02.title" default="Record Not Found" />
                    </h1>
                    <p>
                        <g:message code="show.headingbar02.p01" default="The requested record ID" /> "${uuid}" <g:message code="show.headingbar02.p02" default="was not found" />
                    </p>
                </div>
            </g:if>
        ...
        <g:else>
            <h3>
                <g:message code="show.body.error.title" default="An error occurred" />
                <br />
                ${flash.message}
            </h3>
        </g:else>
