...
<html>
    <head>
        ...
        <title>
            <g:message code="home.index.title" default="Search for records" /> | ${hubDisplayName}
        </title>
    ...
    <body>
        <g:if test="${flash.message}">
            <div class="message alert alert-info">
                ...
                <b>
                    <g:message code="home.index.body.alert" default="Alert:" />
                </b>
                ${raw(flash.message)}
            </div>
        </g:if>
        ...
        <div>
            <div class="page-header">
                ...
                <div class="page-header__subtitle">
                    <%-- TODO --%>
                    <g:message code="home.index.body.title" default="Search for records in" />
                    ${raw(hubDisplayName)}
                </div>
            </div>
                ...
                <ul class="nav nav-tabs" id="searchTabs">
                    <li class="nav-item">
                        <a id="t1" href="#simple-search" data-toggle="tab" class="nav-link active">
                            <g:message code="home.index.navigator01" default="Simple search" />
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content searchPage">
                ...
                <div id="taxa-upload" class="tab-pane">
                    <form name="taxaUploadForm" id="taxaUploadForm" action="${biocacheServiceUrl}/occurrences/batchSearch" method="POST">
                        <p>
                            <g:message code="home.index.taxaupload.des01" default="Enter a list of taxon names/scientific names, one name per line (common names not currently supported)." />
                        </p>
